...
contract StableCoinUSDT is ERC20, Ownable {
...
/// @title StableCoin: An ERC20 token with staking and burning capabilities
contract StableCoinUSDC is ERC20, Ownable {
    bool public paused = false;
